...
def train_model():
    ...
    # Calculate 120-day SMA, then handle NaN values
    ...
    for i in range(365, len(close_prices)):
        ...
        # Combine close prices and SMA_120 as features
        combined_features = np.column_stack((close_features, sma_120_features))
    ...
    # Now we have 2 features per time step (close price and SMA_120)
    ...
    model = Sequential([
        LSTM(16, return_sequences=True, input_shape=(X_train_scaled.shape[1], 2), kernel_regularizer=l1_l2(l1=1e-4, l2=1e-4)),
        Dropout(0.3),
