...
def train_model():
    ...
    model = Sequential([
        LSTM(16, return_sequences=True, input_shape=(X_train_scaled.shape[1], 4), kernel_regularizer=l1_l2(l1=1.6e-3, l2=2e-4)),
        Dropout(0.6),
        LSTM(8, return_sequences=False, kernel_regularizer=l1_l2(l1=1.6e-3, l2=2e-4)),
        Dropout(0.6),
        Dense(4, activation='relu', kernel_regularizer=l1_l2(l1=1.6e-3, l2=2e-4)),
